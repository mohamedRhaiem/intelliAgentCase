...
import { changeProvider } from '../../redux/actionsThunk/repositoryActions'
...
const SelectProvider = (props) => {
    ...
    const handleChange = (e) => {
        if (e.target.value == props.provider) {
            ...
            props.changeProvider(e.target.value)
        }
    }
    return (
        <Row>
...
export default connect(mapStateToProps, { changeProvider })(SelectProvider);